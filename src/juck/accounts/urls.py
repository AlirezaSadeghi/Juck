...
# Sina vared mishavad
                       url(r'^password_reset/$', password_reset,
                           {'post_reset_redirect': '/password_reset_done/' , 'template_name': 'accounts/password_reset_form.html'}, name="password_reset"),
                       ...
                       url(r'^password_reset/(?P<uidb36>[0-9A-Za-z]+)-(?P<token>.+)/$',
                           ...
                           {'post_reset_redirect': '/password_done/' , 'template_name': 'accounts/password_reset_confirm.html'}),
