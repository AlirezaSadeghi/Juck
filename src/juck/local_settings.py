...
TEMPLATE_DIRS = ( # in here JUST import django admin templates
                  '/usr/local/lib/python2.6/dist-packages/Django-1.3.1-py2.6.egg/django/contrib/admin/templates',
                  # for ubuntu 10.04 users with easy_install
                  '/usr/local/lib/python2.7/dist-packages/Django-1.3.1-py2.7.egg/django/contrib/admin/templates',
                  # for other ubuntu users with easy_install
